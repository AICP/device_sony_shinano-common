...
BOARD_KERNEL_CMDLINE  := androidboot.hardware=qcom msm_rtb.filter=0x3b7 ehci-hcd.park=3
BOARD_KERNEL_CMDLINE  += dwc3.maximum_speed=high dwc3_msm.prop_chg_detect=Y vmalloc=300M
