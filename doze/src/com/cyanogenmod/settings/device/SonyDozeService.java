...
public class SonyDozeService extends Service {
    private static final String TAG = "SonyDozeService";
    ...
    private SonyProximitySensor mSensor;
    ...
    class SonyProximitySensor implements SensorEventListener {
        ...
        public SonyProximitySensor(Context context) {
    ...
    public void onCreate() {
        if (DEBUG) Log.d(TAG, "SonyDozeService Started");
        mContext = this;
        mPowerManager = (PowerManager)getSystemService(Context.POWER_SERVICE);
        mSensor = new SonyProximitySensor(mContext);
